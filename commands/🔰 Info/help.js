...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls) => {
    if (args[0]) {
      ...
      let button_tutorial = new MessageButton().setStyle('LINK').setEmoji("840260133686870036").setLabel("Tutorial").setURL("https://youtube.com/ItzNexus")
      let menuOptions = [{
          label: "Overview",
          value: "Overview",
...
<:MilratoDevelopment:900389724936609842>  Made by [Milrato Development](https://discord.gg/milrato) & [**ItzNexus**](https://youtube.com/ItzNexus)`)
